...
--model_supervision 2 --netG 41311 --channels_G 64 --num_epochs 500 \
--checkpoints_dir ./checkpoints/checkpoints_b4_bipDEC_1spade_catFeat_3iter33styles_1