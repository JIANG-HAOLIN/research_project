...
def add_all_arguments(parser, train):
    ...
    # parser.add_argument('--dataroot', type=str, default='/Users/hlj/Documents/NoSync.nosync/FA/cityscapes', help='path to dataset root')
...
### jhl #################
    parser.add_argument('--hidden_size',  default=512,type=int, help='latent size')##jhl
    parser.add_argument('--style_dim',  default=512,type=int, help='style vector size')##jhl
    parser.add_argument('--activation',  default=None, help='??')##jhl
    parser.add_argument('--channel_multiplier',  default=2,type=int)##jhl
    parser.add_argument('--n_mlp',  default=8,type=int, help='num of layers in mapping network')##jhl
    parser.add_argument('--lr_mlp',  default=0.01,type=float, help='num of layers in mapping network')##jhl
    ...
    parser.add_argument('--add_dist', action='store_true', default=False, help='implement intra-class positional embedding')

    # for transformer-encoder
    parser.add_argument('--num_layers',  default=2, help='amount of layers in transformer-encoder')##jhl
    parser.add_argument('--dim',  default=1024, help='token size')##jhl


    # for multi scale structure
    parser.add_argument('--final_channel',  default=64,type=int, help='token size')##jhl
    parser.add_argument('--input_size',  default=(16,32), help='input coords size')##jhl
    parser.add_argument('--netD', type=str, default='undefined', help="discriminator architecture")
