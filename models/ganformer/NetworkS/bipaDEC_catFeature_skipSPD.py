...
class DecoderBlock_1spade(torch.nn.Module):
    def __init__(self,
        ...
        **layer_kwargs                      # Arguments for SynthesisLayer
        ...
        print('catFeature_skipSPD constructed with same feature ')
    ...
    def forward(self,input_feature_block,emb,label, x, img, ws, att_vars, fused_modconv = None, **layer_kwargs):
        ...
        if self.stem:
            ...
            x, att_maps[0], att_vars = self.conv0(None, x, next(w_iter), att_vars,
                                                  fused_modconv=fused_modconv,
                                                  feature_from_encoder=input_feature_block[-1],
                                                    **layer_kwargs)
...
class BipartiteDecoder_catFeature_skipSPD(torch.nn.Module):
    def __init__(self,
