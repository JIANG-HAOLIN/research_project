...
import models.lib_loss_contrastive.loss_contrast_mem as loss_contrast
...
class OASIS_model(nn.Module):
    def __init__(self, opt):
        ...
        self.loss_contrast = loss_contrast.ContrastCELoss()
        self.coords=None
        self.latent=None
    ...
    def forward(self, image, label,label_class_dict, mode, losses_computer,
        ...
        if mode == "losses_G":
            ...
            outputs = {'key': _.detach(),'lb_key': label_map.detach()}
            ...
            loss_contrast = self.loss_contrast(outputs,label_map)
            loss_G = loss_G + loss_contrast
